  ...
  <script>
    function checkDelete() {
      if (confirm('Aset akan dipadam. Adakah ingin teruskan ?')) {
        window.location.href = "asset_lan_delete.php?id=<?php echo $_GET['id'] ?>"
      }
    }
  </script>
</head>
  ...
  <div class="">
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12  ">
        <div class="x_panel">
          <div class="x_title">
            <h2>Paparan Maklumat LAN Switch</h2>
          ...
          <div class="x_content">
            <form role="form" action="asset_lan_edit.php?id=<?php echo $id ?>" method="post" id="registration-form"
              autocomplete="off">
          ...
          <div class='form-group row'>
            ...
            <div class="col-md-4 col-sm-6 ">
              <input id="sumber" name="sumber" type="text" class="form-control" value="<?php echo $asset['sumber'] ?>" disabled>
            </div>
          </div>

          <div class='form-group row'>
            <label class="col-form-label col-md-3 col-sm-3 label-align" for="port">Bilangan Port</label>
            <div class="col-md-4 col-sm-6 ">
              <input id="port" name="port" type="text" class="form-control" value="<?php echo $asset['bil_port'] ?>" disabled>
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-4 col-sm-3 ">
              <button type="button" name="delete" class="btn btn-danger" onclick="return checkDelete();"
                href="asset_lan_delete.php?id=<?php echo $id ?>">Padam</button>
