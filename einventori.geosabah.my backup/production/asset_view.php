                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <ul class="nav nav-tabs " id="myTab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="printer-tab" data-toggle="tab" href="#printer" role="tab" aria-controls="printer" aria-selected="false">Printer</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="scanner-tab" data-toggle="tab" href="#scanner" role="tab" aria-controls="scanner" aria-selected="false">Scanner</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="ups-tab" data-toggle="tab" href="#ups" role="tab" aria-controls="ups" aria-selected="false">Uninterruptible Power Supply</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="avr-tab" data-toggle="tab" href="#avr" role="tab" aria-controls="avr" aria-selected="false">Automatic Voltage Regulator</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="lcd-tab" data-toggle="tab" href="#lcd" role="tab" aria-controls="lcd" aria-selected="false">Projector</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="lan_switch-tab" data-toggle="tab" href="#lan_switch" role="tab" aria-controls="lan_switch" aria-selected="false">Switch</a>
                                </li>
                                <li class="nav-item">
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="desktop" role="tabpanel" aria-labelledby="desktop-tab">
                                    <table id="datatable-buttons1" class="table datatable-buttons responsive table-striped table-bordered nowrap" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
...
";
                        ...
                        <a href="asset_komputer_delete.php?id=' . $id . '" onclick="return checkDelete()")"><i class="fa fa-close"  style="font-size:19px;;color:red;margin:0px 5px 0px 5px "  title="Padam"></i></a>
                                ...
                                <div class="tab-pane fade" id="laptop" role="tabpanel" aria-labelledby="laptop-tab">
                                    <table id="datatable-buttons2" class="table datatable-buttons responsive table-striped table-bordered nowrap" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                <th scope="col">Nama Pengguna</th>
                                                <th scope="col">Lokasi Pejabat</th>
...
ORDER BY s.name ASC;                          ";
                        ...
                        <a href="asset_laptop_delete.php?id=' . $id . '" onclick="return checkDelete()")"><i class="fa fa-close"  style="font-size:19px;;color:red;margin:0px 5px 0px 5px "  title="Padam"></i></a>
                                ...
                                <div class="tab-pane fade" id="monitor" role="tabpanel" aria-labelledby="monitor-tab">
                                    <table id="datatable-buttons3" class="table datatable-buttons responsive table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                <th scope="col">Nama Pengguna</th>
                                                <th scope="col">Lokasi Pejabat</th>
...
";
                        ...
                        <a href="asset_monitor_delete.php?id=' . $id . '" onclick="return checkDelete()")"><i class="fa fa-close"  style="font-size:19px;;color:red;margin:0px 5px 0px 5px "  title="Padam"></i></a>
                                ...
                                <div class="tab-pane fade" id="printer" role="tabpanel" aria-labelledby="printer-tab">
                                    <table id="datatable-buttons4" class="table datatable-buttons responsive table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                <th scope="col">Nama Pengguna</th>
                                                <th scope="col">Lokasi Pejabat</th>
...
ORDER BY s.name ASC;";
                        ...
                        <a href="asset_printer_delete.php?id=' . $id . '" onclick="return checkDelete()")"><i class="fa fa-close"  style="font-size:19px;;color:red;margin:0px 5px 0px 5px "  title="Padam"></i></a>
                                ...
                                <div class="tab-pane fade" id="scanner" role="tabpanel" aria-labelledby="scanner-tab">
                                    <table id="datatable-buttons5" class="table datatable-buttons responsive table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                <th scope="col">Nama Pengguna</th>
                                                <th scope="col">Lokasi Pejabat</th>
...
ORDER BY s.name ASC;   
                        ...
                        <a href="asset_scanner_delete.php?id=' . $id . '" onclick="return checkDelete()")"><i class="fa fa-close"  style="font-size:19px;;color:red;margin:0px 5px 0px 5px "  title="Padam"></i></a>
                                ...
                                <div class="tab-pane fade" id="ups" role="tabpanel" aria-labelledby="ups-tab">
                                    <table id="datatable-buttons6" class="table datatable-buttons responsive table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                <th scope="col">Nama Pengguna</th>
                                                <th scope="col">Lokasi Pejabat</th>
...
ORDER BY s.name ASC;                          ";
                        ...
                        <a href="asset_ups_delete.php?id=' . $id . '" onclick="return checkDelete()")"><i class="fa fa-close"  style="font-size:19px;;color:red;margin:0px 5px 0px 5px "  title="Padam"></i></a>
                                ...
                                <div class="tab-pane fade" id="avr" role="tabpanel" aria-labelledby="avr-tab">
                                    <table id="datatable-buttons7" class="table datatable-buttons responsive table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                <th scope="col">Nama Pengguna</th>
                                                <th scope="col">Lokasi Pejabat</th>
...
ORDER BY s.name ASC;                          ";
                        ...
                        <a href="asset_avr_delete.php?id=' . $id . '" onclick="return checkDelete()")"><i class="fa fa-close"  style="font-size:19px;;color:red;margin:0px 5px 0px 5px "  title="Padam"></i></a>
                                ...
                                <div class="tab-pane fade" id="lcd" role="tabpanel" aria-labelledby="lcd-tab">
                                    <table id="datatable-buttons8" class="table datatable-buttons responsive table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                <th scope="col">Nama Pengguna</th>
                                                <th scope="col">Lokasi Pejabat</th>
...
ORDER BY s.name ASC;   
                        ...
                        <a href="asset_lcd_delete.php?id=' . $id . '" onclick="return checkDelete()")"><i class="fa fa-close"  style="font-size:19px;;color:red;margin:0px 5px 0px 5px "  title="Padam"></i></a>
                                ...
                                <div class="tab-pane fade" id="lan_switch" role="tabpanel" aria-labelledby="lan_switch-tab">
                                    <table id="datatable-buttons9" class="table datatable-buttons responsive table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                <th scope="col">Nama Pengguna</th>
                                                <th scope="col">Lokasi Pejabat</th>
...
ORDER BY s.name ASC;   
                        ...
                        <a href="asset_lan_delete.php?id=' . $id . '" onclick="return checkDelete()")"><i class="fa fa-close"  style="font-size:19px;;color:red;margin:0px 5px 0px 5px "  title="Padam"></i></a>
                                ...
                                <div class="tab-pane fade" id="tablet" role="tabpanel" aria-labelledby="tablet-tab">
                                    <table id="datatable-buttons10" class="table datatable-buttons responsive table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                <th scope="col">Nama Pengguna</th>
                                                <th scope="col">Lokasi Pejabat</th>
