          ...
          <div class="x_panel">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Maklumat Scanner</h2>
                    <div class="clearfix"></div>
                  </div>
                  <label><?php echo $required ?></label>
                  <div class="x_content">
                    <form role="form" action="insert_scanner.php" method="post" id="registration-form"
                      ...
                      <div id="usetype-div">
                        ...
                        <div class="item form-group">
                          <label class="col-form-label col-md-3 col-sm-3 label-align">Resolusi
                          </label>
                          <div class="col-md-6 col-sm-6 ">
                        ...
                        <div class=" field item form-group">
                          ...
                          <div class="col-md-6 col-sm-6">
                            <select id="network" name="network" class="form-control" id="network" >
                              <?php
                              select_options($lan_options, $network);
                              ?>
                            </select>
                          </div>
                        </div>
                      ...
                      <input type="hidden" value="" id="staff_id" name="staff_id"></input>
