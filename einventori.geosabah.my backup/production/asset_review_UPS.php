      ...
      <div class="col-md-12 col-sm-12  ">
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <form role="form" action="asset_ups_edit.php?id=<?php echo $id ?>" method="post" id="registration-form"
              autocomplete="off">
              <input type="text" hidden name="u_id" value="<?= $asset['u_id'] ?>">
          ...
          <div class="form-group row">
            ...
            <div class="col-md-4 col-sm-3 ">
              <button type="button" name="delete" class="btn btn-danger" onclick="return checkDelete();"
                href="asset_ups_delete.php?id=<?php echo $id ?>">Padam</button>
