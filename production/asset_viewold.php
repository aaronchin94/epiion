  ...
  <script type="text/javascript" charset="utf8">
    $(document).ready(function () {
      ...
      $('a[data-toggle="tab"]').on('shown.bs.tab', function (e) {
        ...
        var activeTable = $.fn.dataTable.tables({ visible: true, api: true })[0];
          ...
          <div class="x_panel">
            ...
            <div class="x_content">
              <ul class="nav nav-tabs " id="myTab" role="tablist">
                ...
                <li class="nav-item">
                  <a class="nav-link" id="lan_switch-tab" data-toggle="tab" href="#lan_switch" role="tab"
                    aria-controls="lan_switch" aria-selected="false">Switch</a>
                </li>
                <li class="nav-item">
              ...
              <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="desktop" role="tabpanel" aria-labelledby="desktop-tab">
                  <table id="datatable-buttons1"
                    class="table datatable-buttons responsive table-striped table-bordered nowrap" cellspacing="0"
                    width="100%">
                    <thead>
                      <tr>
