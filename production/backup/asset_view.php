          ...
          <div class="x_panel">
            ...
            <div class="x_content">
              <ul class="nav nav-tabs " id="myTab" role="tablist">
                ...
                <li class="nav-item">
                  <a class="nav-link" id="tablet-tab" data-toggle="tab" href="#tablet" role="tab" aria-controls="tablet"
...
ORDER BY s.name ASC;   
                      ...
                      while ($rowls = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<td>$status </td>";
                        echo '<td>
                        <a href="asset_review_lan.php?id=' . $id . '" ><i class="fa fa-eye" style="font-size:20px;margin:0px 5px 0px 5px ;" title="Papar"></i></a>
                ...
                <table id="datatable-responsive9" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                    <thead>
                      <tr>
                        <th scope="col">Nama Pengguna</th>
                        <th scope="col">Asset ID</th>
...
ORDER BY s.name ASC;                          ";
                      ...
                      while ($rowtablet = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<td>$status </td>";
                        echo '<td>
                        <a href="asset_review_tablet.php?id=' . $id . '" ><i class="fa fa-eye" style="font-size:20px;margin:0px 5px 0px 5px ;" title="Papar"></i></a>
