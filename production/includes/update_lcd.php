...
if (isset($_POST["submit"])) {
    ...
    $l_id = mysqli_real_escape_string($connection, $_POST['l_id']);
    ...
    $stmt->bind_param("sisssssssi", $penggunaan, $staff_id,$model,$tahun, $serial, $kewpa, $status,$jen_perolehan,$sumber,$l_id);
    if ($stmt->execute()) {


        echo "<script>alert('Kemaskini Berjaya');
            window.location.href='../asset_review_lcd.php?id=$l_id'</script>";
