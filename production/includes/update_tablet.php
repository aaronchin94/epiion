...
if (isset($_POST["submit"])) {
    ...
    $t_id = mysqli_real_escape_string($connection, $_POST['t_id']);
    ...
    $stmt->bind_param("sisssssssi", $penggunaan, $staff_id, $model, $tahun, $serial, $kewpa, $status, $jen_perolehan, $sumber, $t_id);
    ...
    if ($stmt->execute()) {
        ...
        echo "<script>alert('Kemaskini Berjaya');
            window.location.href='../asset_review_tablet.php?id=$t_id'</script>";
