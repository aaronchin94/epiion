    ...
    <div class="row">
      <div class="col-md-12 col-sm-12  ">
        <div class="x_panel">
          ...
          <div class="x_content">
            <form role="form" action="asset_lan_edit.php?id=<?php echo intval($id) ?>" method="post" id="registration-form"
              autocomplete="off">
          ...
          <div class="form-group row">
            ...
            <div class="col-md-4 col-sm-3 ">
              <button type="button" name="delete" class="btn btn-danger" onclick="return checkDelete();"
                href="asset_lan_delete.php?id=<?php echo intval($id) ?>">Padam</button>
