  ...
  <div class="">
                      ...
                      <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap"
                        ...
                        <tbody>
                          ...
                          while ($rowk = mysqli_fetch_assoc($result)) {
                            ...
                            //   <a href="asset_maintenance_workmanage.php?id=' . $id . '" ><i class="fa fa-calendar-check-o" style="font-size:20px;margin:0px 5px 0px 5px ;" title="Papar Maklumat"></i></a>
                            ...
                            if ($rowk['work_status'] == 0) {
                              echo '<td>
                              <a href="asset_maintenance_assign.php?id=' . $id . '" ><i class="fa fa-eye" style="font-size:20px;margin:0px 5px 0px 5px ;" title="Papar Maklumat"></i></a>
                              <a href="asset_maintenance_workmanage.php?id=' . $id . '" ><i class="fa fa-calendar-check-o" style="font-size:20px;margin:0px 5px 0px 5px ;" title="Sedia Untuk Diambil"></i></a>
                              </td>';
                            } elseif ($rowk['work_status'] == 1) {
                              echo '<td>
                              <a href="asset_maintenance_assign.php?id=' . $id . '" ><i class="fa fa-eye" style="font-size:20px;margin:0px 5px 0px 5px ;" title="Papar Maklumat"></i></a>
                              <a  href="asset_maintenance_workmanage.php?id=' . $id . '" ><i class="fa fa-check-square" style="font-size:20px;margin:0px 5px 0px 5px;color:#7DDA58;" title="Siap Kerja"onmouseover="this.style.color=\'green\'" onmouseout="this.style.color=\'#7DDA58\'"></i></a>
                              </td>';
                            } else {
                              echo '<td>
                              <a href="asset_maintenance_assign.php?id=' . $id . '" ><i class="fa fa-eye" style="font-size:20px;margin:0px 5px 0px 5px ;" title="Papar Maklumat"></i></a>
    ...
    <script>
      ...
      $('#workModalForm').submit(function (event) {
        ...
        $.ajax({
          type: "POST",
          url: "asset_maintenance_workdone.php",
