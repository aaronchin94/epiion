...
//Grab asset id
$query_cat = "SELECT MAX(ls_id) AS ls_id FROM lan_switch";
$result_cat = $connection->query($query_cat);
foreach ($result_cat as $result_id) {
  $model_id = $result_id["ls_id"] + 1;
}
          ...
          <div class="x_panel">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Maklumat LAN Switch</h2>
                    <div class="clearfix"></div>
                  </div>
                  <label><?php echo $required ?></label>
                  <div class="x_content">
                    <form role="form" action="insert_lan.php" method="post" id="registration-form"
                      ...
                      <div id="usetype-div">
                          ...
                          <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                              <input id="assetid" name="assetid" type="text" class="form-control" readonly="readonly"
                                value=LS10<?php echo intval($model_id) ?>>
                            </div>
                          </div>
                        </div>
                        <div class='model-div'>
                        ...
                        <div class='sumber-div'>
                          <div class="item form-group">
                            <label class="col-form-label col-md-3 col-sm-3 label-align">Bilangan Port <span
                                class="required">*</span>
                            </label>
                            <div class="col-md-6 col-sm-6 ">
                              <input id="port" name="port" type="text" class="form-control" placeholder="Bilangan Port"
                                required>
                            </div>
                          </div>
                        </div>
