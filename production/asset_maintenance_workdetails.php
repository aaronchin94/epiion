                                    ...
                                    foreach ($fileNames as $fileName) {
                                        ...
                                        if (file_exists($filePath)) {
                                            ...
                                            if (strtolower($fileExtension) == 'pdf') {
                                                ...
                                                echo '<a href="' . $filePath . '" target="_blank" style="color: blue; cursor: pointer;">' . sanitizeText($fileName) . '</a><br>';
                                            } else {
                                                // Display file name as a clickable link to open modal
                                                echo '<a href="#" class="file-link" data-file="' . $filePath . '" style="color: blue; cursor: pointer;">' . sanitizeText($fileName) . '</a><br>';
