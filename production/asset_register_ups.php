            ...
            <div class="row">
              <div class="col-md-12 col-sm-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <form role="form" action="insert_ups.php" method="post" id="registration-form"
                          ...
                          <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                              <input id="assetid" name="assetid" type="text" class="form-control" readonly="readonly"
                                value=U10<?php echo intval($model_id) ?>>
                            </div>
                          </div>
                        </div>
                        <div class='model-div'>
