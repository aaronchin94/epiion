...
//Grab asset id
$query_cat = "SELECT MAX(t_id) AS t_id FROM tablet";
$result_cat = $connection->query($query_cat);
foreach ($result_cat as $result_id) {
  $model_id = $result_id["t_id"] + 1;
}
          ...
          <div class="x_panel">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Maklumat Tablet</h2>
                    <div class="clearfix"></div>
                  </div>
                  <label><?php echo $required ?></label>
                  <div class="x_content">
                    <form role="form" action="insert_tablet.php" method="post" id="registration-form"
                          ...
                          <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                              <input id="assetid" name="assetid" type="text" class="form-control" readonly="readonly"
                                value=T10<?php echo intval($model_id) ?>>
                            </div>
                          </div>
                        </div>
                        <div class='model-div'>
                          ...
                          <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6">
                              <select id="perolehan" name="perolehan" class="form-control" required>
                                <?php
                                select_options($jen_options, $jen_perolehan);
                                ?>
                              </select>
                            </div>
                          </div>
