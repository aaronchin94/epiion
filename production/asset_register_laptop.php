...
//Grab asset id
$query_cat = "SELECT MAX(la_id) AS la_id FROM laptop";
$result_cat = $connection->query($query_cat);
foreach ($result_cat as $result_id) {
  $model_id = $result_id["la_id"] + 1;
}
          ...
          <div class="x_panel">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Maklumat Laptop</h2>
                    <div class="clearfix"></div>
                  </div>
                  <label><?php echo $required ?></label>
                  <div class="x_content">
                    <form role="form" action="insert_laptop.php" method="post" id="registration-form"
                      ...
                      <div id="usetype-div">
                          ...
                          <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                              <input id="assetid" name="assetid" type="text" class="form-control" readonly="readonly"
                                value=La10<?php echo intval($model_id) ?>>
                            </div>
                          </div>
                          <div class='model-div'>
                            <div class="item form-group">
                        ...
                        <div class='sumber-div'>
                          <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                              <input id="sumber" name="sumber" type="text" required class="form-control"
                        ...
                        <div class='app_kerja-div'>
                          <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                              <input id="app_kerja" name="app_kerja" type="text" required class="form-control"
                        ...
                        <div class='anti_v-div'>
                          <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                              <input id="anti_v" name="anti_v" type="text" required class="form-control"
                          ...
                          <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                              <input type="text" id="processor" name="processor" class="form-control"
                                placeholder="Processor" required>
                            </div>
                          </div>
                        </div>
                        <div class='ram-div'>
                          ...
                          <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                              <input type="text" class="form-input form-control" id="subnet" name="subnet"
                                placeholder="Subnet Mask" value="255.255.255.0" required />
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                              <input type="text" class="form-input form-control" id="defaultgateway"
                                name="defaultgateway" placeholder="Default Gateway" required />
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                              <input type="text" class="form-input form-control" id="dnsserver" name="dnsserver"
                                placeholder="DNS Server" value="10.250.253.1" required />
                            </div>
                          </div>
                        </div>
