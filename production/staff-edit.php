...
function checkUpdate(){
    return confirm('Maklumat Kakitangan akan dikemaskini. Adakah ingin teruskan ?');
}
</script>
</head>
      <!-- page content -->
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12  ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Kemaskini Maklumat Kakitangan</h2> 
                  ...
                  <?php
                    ...
                    <form role="form" action="includes/updatestaff.php" method="post" id="registration-form" autocomplete="off">
