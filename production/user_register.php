...
$query_drop2 = "
                              ...
                              ORDER BY name ASC
                          ";
$result_drop2 = $connection->query($query_drop2);
        ...
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <form role="form" action="includes/registeruser.php" method="post" id="registration-form"
              ...
              <div class="form-group row">
                <label class="col-form-label col-md-3 col-sm-3 label-align" for="ic">No Kad Pengenalan <span
                    class="required">*</span>
                </label>
              ...
              <div class="form-group row">
                <label class="col-form-label col-md-3 col-sm-3 label-align" for="jawatan">Jawatan <span
                    class="required">*</span>
                </label>
                <div class="col-md-4 col-sm-6 ">
              ...
              <div class="form-group row">
                <label class="col-form-label col-md-3 col-sm-3 label-align" for="lokasi">Daerah <span
                    class="required">*</span>
                </label>
                <div class="col-md-4 col-sm-3 ">
                  <select readonly id="select_box" name="lokasi" class="form-control" required="">
                    <option value="" id="myInput" onkeyup="filterFunction()" onclick="myFunction()">-- Sila Pilih --
                    </option>
                    <?php
              ...
              <div class="form-group row">
                <label class="col-form-label col-md-3 col-sm-3 label-align" for="unit">Bahagian/Seksyen/Unit <span
                    class="required">*</span>
                </label>
                <div class="col-md-4 col-sm-3 ">
                  <select readonly id="select_box" name="unit" class="form-control" required="">
                    <option value="" id="myInput" onkeyup="filterFunction()" onclick="myFunction()">-- Sila Pilih --
                    </option>
                    <?php
              ...
              <div class="form-group row">
                <label class="col-form-label col-md-3 col-sm-3 label-align" for="email">Emel <span
                    class="required">*</span>
                </label>
                <div class="col-md-4 col-sm-6 ">
              ...
              <div class="form-group row">
                <label class="col-form-label col-md-3 col-sm-3 label-align" for="tel">No. Telefon <span
                    class="required">*</span>
                </label>
                <div class="col-md-4 col-sm-6 ">
              ...
              <div class="form-group row">
                <label class="col-form-label col-md-3 col-sm-3 label-align" for="role">Peranan <span
                    class="required">*</span>
                </label>
                <div class="col-md-4 col-sm-3 ">
                  <select id="role" name="role" class="form-control" required="">
                    ...
                    <option value="Admin">Juruteknik</option>
                  </select>
                </div>
              </div>
...
<script>
  function onchangeDropdown(value) {
    self.location = 'user_register.php?name=' + value;
  }
</script>
