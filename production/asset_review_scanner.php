      ...
      <div class="col-md-12 col-sm-12  ">
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <form role="form" action="asset_scanner_edit.php?id=<?php echo intval($id) ?>" method="post" id="registration-form"
              autocomplete="off">
          ...
          <div class="form-group row">
            ...
            <div class="col-md-4 col-sm-6 ">
              <input type="text" name="resolution" id="resolution" class="form-control" disabled="disabled"
                value="<?php echo sanitizeText($asset['resolution']) ?>">
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-4 col-sm-6 ">
              <input type="text" name="network" id="network" required="required" class="form-control"
                disabled="disabled" value="<?php echo sanitizeText($asset['network']) ?>">
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-4 col-sm-3 ">
              <button type="button" name="delete" class="btn btn-danger" onclick="return checkDelete();"
                href="asset_scanner_delete.php?id=<?php echo intval($id) ?>">Padam</button>
