...
//Grab asset id
$query_cat = "SELECT MAX(m_id) AS m_id FROM monitor";
$result_cat = $connection->query($query_cat);
foreach ($result_cat as $result_id) {
  $model_id = $result_id["m_id"] + 1;
}
          ...
          <div class="x_panel">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Maklumat Monitor</h2>
                    <div class="clearfix"></div>
                  </div>
                  <label><?php echo $required ?></label>
                  <div class="x_content">
                    <form role="form" action="insert_monitor.php" method="post" id="registration-form"
                      ...
                      <div id="usetype-div">
                          ...
                          <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                              <input id="assetid" name="assetid" type="text" class="form-control" readonly="readonly"
                                value=M10<?php echo intval($model_id) ?>>
                            </div>
                          </div>
                        </div>
                        <div class='model-div'>
                        ...
                        <div class='size-div'>
                          <div class="item form-group">
                            <label class="col-form-label col-md-3 col-sm-3 label-align">Saiz Monitor <span
                                class="required">*</span>
                            </label>
                            <div class="col-md-6 col-sm-6 ">
                              <input id="size" name="size" type="text" required class="form-control"
                                placeholder="Saiz Monitor">
                            </div>
                          </div>
                        </div>
                      ...
                      <div class='sumber-div'>
                        <div class="item form-group">
                          ...
                          <div class="col-md-6 col-sm-6 ">
                            <input id="sumber" name="sumber" type="text" class="form-control" placeholder="Sumber Penerimaan"
                              required>
                          </div>
                        </div>
                      </div>
