  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <input type="date" id="estimated_completion_date" class="form-control" required>
        <br>
        <label for="estimated_deliver_date">Tarikh Penghantaraan Aset Kepada Juruteknik:</label>
        <input type="date" id="estimated_deliver_date" class="form-control" required>
      </div>
      <div class="modal-footer">
        <button type="button" id="terimaBtn" class="btn btn-success"
          onclick="approveMaintenance('<?php echo $id; ?>')">Terima</button>
