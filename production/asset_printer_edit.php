  ...
  <div class="">
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12  ">
        <div class="x_panel">
          <div class="x_title">
            <h2>Kemaskini Maklumat Printer</h2>
          ...
          <div class="form-group row">
            <label class="col-form-label col-md-3 col-sm-3 label-align" for="name">Jenis Cetakan <span
                class="required">*</span>
            </label>
            <div class="col-md-4 col-sm-6 ">
              <select id="jen_cetakan" name="jen_cetakan" class="form-control" required>
                <?php
                select_options($cetakan_options, $asset['jen_cetakan']);
                ?>
              </select>
            </div>
          </div>
