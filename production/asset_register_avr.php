            ...
            <div class="row">
              <div class="col-md-12 col-sm-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <form role="form" action="insert_avr.php" method="post" id="registration-form"
                        ...
                        <div class='perolehan-div'>
                          <div class="item form-group">
                            <label class="col-form-label col-md-3 col-sm-3  label-align">Jenis Perolehan <span
                                class="required">*</span></label>
                            <div class="col-md-6 col-sm-6">
                              <select id="perolehan" name="perolehan" class="form-control" title="" required>
                                <?php
                          ...
                          <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                              <input id="sumber" name="sumber" type="text" class="form-control"
                                placeholder="Sumber Penerimaan" title="" required>
                            </div>
                          </div>
                        </div>
